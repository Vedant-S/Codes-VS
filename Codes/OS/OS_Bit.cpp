/*Conventions:
(1) in bit vector, 0 is free block, 1 is used/allocated block
(2)in link list, the address of memory blocks which are free, is stored (i.e bit-0)
*/
...
int main()
{
 cout<<"\t\t_________FREE SPACE ALLOCATION_________"<<endl<<endl;
